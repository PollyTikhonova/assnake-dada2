...
# rule dada2_nochim:
#     input: '{fs_prefix}/{df}/dada2/{sample_set}/seqtab.rds'
#     output: '{fs_prefix}/{df}/dada2/{sample_set}/seqtab_nochim.rds'
#     conda: 'dada2.yaml'
#     wildcard_constraints:    
#         sample_set="[\w\d_-]+",
#         err_params="[\w\d_-]+"
...
#     input: '{fs_prefix}/{df}/dada2/{sample_set}/seqtab_nochim.rds'
#     output: '{fs_prefix}/{df}/dada2/{sample_set}/taxa.rds'
#     conda: 'dada2.yaml'
