...
db2_silva__species_nr_v132 = config.get('dada2-silva_species_assignment_v132', None)
rule dada2_assign_taxa:
    ...
    threads: 24
    conda: '../dada2.yaml'
    shell: ("Rscript {assign_taxa_script} '{input}' '{output}' '{db_silva_nr_v132}' '{db2_silva__species_nr_v132}' {threads}")